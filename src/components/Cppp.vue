        ...
        async launchProject() {
            ...
            try {
                const docRef = await addDoc(collection(db, "Project Collection"), {
                    ...
                    projectMembers: this.projectMembers, projectImage: this.projectImage ? this.projectImage != null : this.defaultThumbnail, projectBackground: this.projectBackground ? this.projectBackground != null : this.defaultBackground,
