<template>
    ...
    <div class="background">
        <img id="background" v-if="projectBackground.length == 0" src="../assets/CpppImage.png" alt="not found">
        <img id="background" v-else :src="projectBackground" alt="not found">
        <br>
        <button id="addBackground" @click="triggerFileUpload">Add Background</button>
    </div> <br> <br>
